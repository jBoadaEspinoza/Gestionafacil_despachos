...
public class BuscarController {
    ...
    public void buscarDespachos(String operacion, String eId, String token, String aDenominacion, final DespachoCallback callback) {
        Call<JsonObject> call = service.buscarDespacho(operacion, eId, token, aDenominacion);
